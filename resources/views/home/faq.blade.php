...
<!-- Mirrored from rockstheme.com/rocks/aievari-live/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Mar 2022 18:29:57 GMT -->
<head>
		<meta charset="utf-8">
									...
									<div class="panel-group" id="accordion">
										...
										<div class="panel panel-default">
											...
											<div id="check2" class="panel-collapse collapse">
												<div class="panel-body">
													<p>
														We accept: Perfect Money, Payeer, Bitcoin, Litecoin, Bitcoin Cash, Ethereum. <br>
														You can open a free Perfect Money account here: www.perfectmoney.is <br>
														You can open a free Payeer account here: www.payeer.com <br>
														You can open a free Bitcoin, Litecoin, Bitcoin Cash, Ethereum account here: www.coinpayments.net</p>
													</p>										
												</div>
											</div>
										</div>
											...
											<div class="panel-heading">
												<h4 class="check-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#check5">
														<span class="acc-icons"></span>AFTER I MAKE A WITHDRAWAL REQUEST, WHEN WILL THE FUNDS BE AVAILABLE ON MY  ECURRENCY ACCOUNT?
													</a>
												</h4>
											</div>
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="check-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#check5">
														<span class="acc-icons"></span>HOW WILL BE ADD REFERRAL COMMISSION FOR DEPOSIT?
													</a>
												</h4>
											</div>
											<div id="check5" class="panel-collapse collapse">
												<div class="panel-body">
													<p>
														Referral commission will be added to upline only when user make deposit from wallet.
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="check-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#check5">
														<span class="acc-icons"></span>HOW LONG DOES IT TAKE FOR MY DEPOSIT TO BE ADDED TO MY ACCOUNT?
													</a>
												</h4>
											</div>
											<div id="check5" class="panel-collapse collapse">
